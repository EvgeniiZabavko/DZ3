...
// Решение:
function getOverpaymentAmount(amountCredit) {
    const percent = 17 / 100;
    const years = 5;
    return amountCredit * (percent * years);
}
console.log(getOverpaymentAmount(5000));
...
function withNumberArgs(func) {
    return function (a, b) {
        if (typeof a !== 'number' || typeof b !== 'number') {
            console.error('Некорректно введенные данные.');
            return 0;
        }
        return func(a, b);
    }
